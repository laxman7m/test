...
from requests.packages.urllib3.exceptions import InsecureRequestWarning #Suppresses cert warning
requests.packages.urllib3.disable_warnings(InsecureRequestWarning) #Suppresses cert warning
